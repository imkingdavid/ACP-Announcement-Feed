...
/**
 * Parse RSS feed returned by get_feed
 *
 * @param int $limit Total number of items to show at a time
 */
...
/**
 * Retrieve and return the RSS feed from phpBB.com announcements forum
 *
 * @return SimpleXMLElement object containing RSS feed
 */
function get_feed()
{
